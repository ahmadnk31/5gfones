-- Fix the create_order_from_items function to work with the current database schema

-- Drop the existing function if it exists
DROP FUNCTION IF EXISTS create_order_from_items;
...
BEGIN
    ...
    -- Create the order with the user_uid as both customer_id and user_uid
    -- This works because we're moving away from the customers table
    INSERT INTO orders (
        customer_id,
        total_amount,
        status,
